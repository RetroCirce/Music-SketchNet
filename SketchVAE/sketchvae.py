...
#         print("vae forward", self.training)
        ...
        zr = r_dis.rsample()
        z = torch.cat((zp,zr), -1)
#         print("z:",zp.size(),zr.size(),z.size())
